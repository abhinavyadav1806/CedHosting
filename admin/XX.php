                    ...
                    <div class="card-body">
                        <form action="addproduct.php" method="post">
                            <div class="form-group">
                                <label for="exampleFormControlSelect1">Select Category <span
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Enter Product Name <span
                                        style="color:red">*</span></label>
                                <input type="text" class="form-control productname" name="productname"
                                    pattern="(^([A-z]+\-[0-9]+)$)|(^([A-z])+$)" class="productname" required
                            ...
                            <br>
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Enter Monthly Price <span
                                        style="color:red">*</span></label>
                                <input type="number" class="form-control mpriceid" name="monthlyprice"
                                    pattern="\d{1,15}" required placeholder="ex. 23">
                                <small>This would be monthly plan</small>
                            </div>
                            <p id="lablemprice"></p>
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Enter Annual Price <span
                                        style="color:red">*</span></label>
                                <input type="number" class="form-control apriceid" name="annualprice" required
                                    placeholder="ex. 23">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control sku" name="sku"
                                    pattern="^[a-zA-Z0-9#](?:[a-zA-Z0-9_-]*[a-zA-Z0-9])?$" required placeholder="">
                            </div>
                            <p id="sku"></p>
                            ...
                            <br>
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Web Spaces(in GB) <span
                                        style="color:red">*</span></label>
                            ...
                            <p id="lableweb"></p>
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Bandwidth (in GB) <span
                                        style="color:red">*</span></label>
                            ...
                            <p id="lableband"></p>
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Free Domain <span
                                        style="color:red">*</span></label>
                            ...
                            <p id="prodfree"></p>
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Language/Technology Supporty <span
                                        style="color:red">*</span></label>
